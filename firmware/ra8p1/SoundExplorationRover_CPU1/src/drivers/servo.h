 ...
 * @brief  RCサーボ制御API
 * ================================================================= */
#ifndef SEROV_CPU1_DRIVER_SERVO_H
#define SEROV_CPU1_DRIVER_SERVO_H

#include "config/pin_config.h"                             /* サーボPWM resource mapping */
#include "config/servo_config.h"                           /* サーボ数と校正 */
...
#endif /* SEROV_CPU1_DRIVER_SERVO_H */
