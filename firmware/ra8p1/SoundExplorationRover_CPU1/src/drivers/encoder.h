...
EXPORT void encoder_left_a_irq_callback(external_irq_callback_args_t * p_args); /* 左A相割込み */
EXPORT void encoder_left_b_irq_callback(external_irq_callback_args_t * p_args); /* 左B相割込み */
EXPORT void encoder_right_a_irq_callback(external_irq_callback_args_t * p_args); /* 右A割込み */
EXPORT void encoder_right_b_irq_callback(external_irq_callback_args_t * p_args); /* 右B割込み */

/**< 左代表モーターの累積カウント（前進正） */
IMPORT volatile W g_encoder_left_count;
/**< 右代表モーターの累積カウント（前進正） */
IMPORT volatile W g_encoder_right_count;
IMPORT volatile W g_encoder_left_rpm_x10;                   /**< 左推定RPM×10（前進正） */
IMPORT volatile W g_encoder_right_rpm_x10;                  /**< 右推定RPM×10（前進正） */
