...
void jga25_encoder_left_a_callback(external_irq_callback_args_t * p_args); /* 左A相割込みコールバック */
void jga25_encoder_left_b_callback(external_irq_callback_args_t * p_args); /* 左B相割込みコールバック */
void jga25_encoder_right_a_callback(external_irq_callback_args_t * p_args); /* 右A相割込みコールバック */
void jga25_encoder_right_b_callback(external_irq_callback_args_t * p_args); /* 右B相割込みコールバック */
