...
fsp_err_t dc_motor_request_rpm(int16_t left_rpm, int16_t right_rpm); /* 左右目標回転数設定 */
fsp_err_t dc_motor_housekeeping_1ms(void);                  /* ソフトスタート更新 */
fsp_err_t dc_motor_stop(void);                              /* 左右モーター即時停止 */
int16_t dc_motor_left_target_rpm_get(void);                 /* 左モーター目標回転数取得 */
int16_t dc_motor_right_target_rpm_get(void);                /* 右モーター目標回転数取得 */
