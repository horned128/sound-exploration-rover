...
#define CPU0_SENSOR_RECOVER_CLEAR_MM       (650U)
...
#define CPU0_SOUND_LOST_TIMEOUT_MS         (1500U)
...
/* 現場学習音響識別の走行反映: 0で従来互換（DoA+音量追従）、1で学習見本一致時のみ追従 */
#define CPU0_SOUND_REQUIRE_IDENTIFIER_MATCH (1U)
#define CPU0_SOUND_IDENTIFIER_TIMEOUT_MS   (1000U)
