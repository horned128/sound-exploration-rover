...
LOCAL fsp_err_t task_acoustic_link_telemetry_start(void) {
    ...
    task_command_snapshot_t command_snapshot;
    ER const snapshot_err = task_command_snapshot_get(&command_snapshot);
    ...
    if (E_OK != task_sensor_snapshot_get(&sensor_snapshot)) {
    ...
    acoustic_rover_telemetry_t telemetry = {
        ...
        .usb_state = (UB) g_task_acoustic_link_usb_state,
        .flags = flags,
        .doa_deg = g_task_acoustic_link_observation.doa_deg,
        .level_dbfs_x100 = g_task_acoustic_link_observation.level_dbfs_x100,
        .peak_dbfs_x100 = g_task_acoustic_link_observation.peak_dbfs_x100,
        .vad = g_task_acoustic_link_observation.vad,
        .xvf_status = g_task_acoustic_link_observation.xvf_status,
        .audio_flags = g_task_acoustic_link_observation.audio_flags,
        .xvf_raw_status = g_task_acoustic_link_observation.xvf_raw_status,
        .observation_sequence = audio_observation_sequence,
        .observation_age_ms = (ACOUSTIC_PROTOCOL_DOA_INVALID != g_task_acoustic_link_observation.doa_deg)
                                  ? (audio_now_ms - audio_observation_at_ms)
                                  : UINT32_MAX,
        .audio_frame_count = g_task_acoustic_link_observation.audio_frame_count,
        .audio_crc_error_count = g_task_acoustic_link_crc_error_count,
        .fault_flags = g_task_think_fault_flags,
        .steering_deg = g_task_think_steering_deg,
        ...
        .command_sequence = g_task_command_sequence,
        .command_last_error = (W) g_task_command_last_error,
        .command_target_age_ms = command_snapshot.target_age_ms,
        .command_send_count = g_task_command_send_count,
