...
IMPORT volatile UH g_task_sensor_tof_distance_mm[CPU0_SENSOR_TOF_COUNT]; /**< ToF距離[mm] */
...
IMPORT volatile UB g_task_sensor_tof_range_status[CPU0_SENSOR_TOF_COUNT]; /**< ToF生Range Status */
IMPORT volatile UB g_task_sensor_tof_result[CPU0_SENSOR_TOF_COUNT]; /**< ToF読出し結果分類 */
