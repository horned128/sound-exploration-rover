...
#define CPU0_FAULT_ALL_MASK                                                                                            \
    (CPU0_FAULT_TASK_CREATE | CPU0_FAULT_TASK_START | CPU0_FAULT_IPC_INIT | CPU0_FAULT_IPC_SEND |                      \
     CPU0_FAULT_COMMAND_TARGET_TIMEOUT | CPU0_FAULT_TARGET_UPDATE | CPU0_FAULT_USB_INIT)
