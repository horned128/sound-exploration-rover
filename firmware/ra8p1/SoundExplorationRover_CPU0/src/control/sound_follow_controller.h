...
typedef enum e_sound_follow_state {
    ...
    CPU0_THINK_STATE_SENSOR_SAFE_STOP,
    CPU0_THINK_STATE_SENSOR_FORWARD,
    CPU0_THINK_STATE_SENSOR_CAUTION_FORWARD,
    CPU0_THINK_STATE_SENSOR_TURN_LEFT,
    CPU0_THINK_STATE_SENSOR_TURN_RIGHT,
