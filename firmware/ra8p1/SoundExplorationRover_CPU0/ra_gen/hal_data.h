...
extern const usb_instance_t g_acoustic_ai_lab_usb;

/** Access the USB instance using these structures when calling API functions directly (::p_api is not used). */
extern usb_instance_ctrl_t g_acoustic_ai_lab_usb_ctrl;
extern const usb_cfg_t g_acoustic_ai_lab_usb_cfg;
