...
#include "hal_data.h"
usb_instance_ctrl_t g_acoustic_ai_lab_usb_ctrl;

#if !defined(NULL)
extern usb_descriptor_t NULL;
#endif
#define RA_NOT_DEFINED (1)
const usb_cfg_t g_acoustic_ai_lab_usb_cfg = { .usb_mode = USB_MODE_PERI,
		.usb_speed = USB_SPEED_FS, .module_number = 0, .type = USB_CLASS_PCDC,
#if defined(NULL)
                .p_usb_reg = NULL,
#else
		.p_usb_reg = &NULL,
...
const usb_instance_t g_acoustic_ai_lab_usb = { .p_ctrl =
		&g_acoustic_ai_lab_usb_ctrl, .p_cfg = &g_acoustic_ai_lab_usb_cfg,
		.p_api = &g_usb_on_usb, };
